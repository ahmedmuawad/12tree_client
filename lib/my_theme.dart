...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(86, 165, 0, 1.0);
  static Color soft_accent_color = Color.fromRGBO(189, 247, 168, 1.0);
  static Color splash_screen_color = Color.fromRGBO(255, 255, 255, 1.0); // if not sure , use the same color as accent color
